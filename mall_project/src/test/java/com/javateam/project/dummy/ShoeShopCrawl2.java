...
public class ShoeShopCrawl2 {
	...
	public void productDummyGenerator() throws IOException {
		...
		// String targetImagePath = "D:\\jth\\works\\project2\\download_p_images\\";
		...
		kinds.put(5, "001013"); // 스니커즈
		// kinds.put(6, ""); // 세일
		
		String url = "https://www.saltandchocolate.co.kr/goods/goods_list.php?cateCd=";
